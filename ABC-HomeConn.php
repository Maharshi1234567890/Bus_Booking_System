...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ABC-HomeConnCSSn.css">
</head>
<nav class="navbar navbar-inverse">
	...
	<div class="container">
		...
		<table id="t1" width="600" border="2" cellpadding="5" cellspacing="5">
			...
			<tbody>
				<?php
					$conn=mysqli_connect("localhost:4306","root","","busbooking");
					if(!$conn)
					{
		...
		<table id="t2" width="600" border="1" cellpadding="1" cellspacing="1">
			...
			<tbody>
				<?php
					$sqlarr="Select * from bus where Origin='".$destination."' and Destination='".$origin."'";
