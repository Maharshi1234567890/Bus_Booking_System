...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Pacifico|Paytone+One" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="ABC-HomeCSS.css">
</head>
...
<body>
  ...
  <!--Tabs-->
    ...
    <ul class="nav nav-tabs">
      <li class="active"><a class="tabshead" data-toggle="tab" href="#home"> Buses</a></li>
    </ul>
    <!--Tabs Headings End-->
    ...
    <div class="tab-content">
      ...
      <div id="home" class="tab-pane fade in active">
        <h3 class="lab">Buses</h3>
        <form action="ABC-HomeConn.php" method="POST"> 
  ...
  <!--Login Modal End-->
  <script type="text/javascript" src="ABC-HomeJSnew.js"></script>
</body>
</html>
